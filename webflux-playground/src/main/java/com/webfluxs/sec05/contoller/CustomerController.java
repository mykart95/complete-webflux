package com.webfluxs.sec05.contoller;

import com.webfluxs.sec05.dto.CustomerDto;
import com.webfluxs.sec05.exceptions.ApplicationExceptions;
import com.webfluxs.sec05.service.CustomerService;
import com.webfluxs.sec05.validator.RequestValidator;
...
//                .flatMap(c->requestValidator.validate(c.block(Duration.ofSeconds(1))).then(c))
//                .flatMap(d->customerService.updateCustomer(id, mono));
