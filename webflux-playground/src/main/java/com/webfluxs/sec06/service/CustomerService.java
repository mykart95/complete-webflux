package com.webfluxs.sec06.service;

import com.webfluxs.sec06.dto.CustomerDto;
import com.webfluxs.sec06.mapper.EntityDtoMapper;
import com.webfluxs.sec06.repository.CustomerRepository;
...
public class CustomerService {
    ...
    public Mono<CustomerDto> saveCustomer(CustomerDto customer) {
        return Mono.just(customer)
                .map(EntityDtoMapper::toEntity) // we should do input validation. let's worry about it later!
