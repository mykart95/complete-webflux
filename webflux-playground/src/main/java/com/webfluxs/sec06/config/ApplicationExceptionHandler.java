...
import com.webfluxs.sec06.exceptions.CustomerNotFoundException;
import com.webfluxs.sec06.exceptions.InvalidInputException;
...
public class ApplicationExceptionHandler {
    ...
    public Mono<ServerResponse> handleException(CustomerNotFoundException ex, ServerRequest request) {
        return handleException(HttpStatus.NOT_FOUND, ex, request, problem->{
            problem.setType(URI.create("http://localhost:8080/api/docs"));
    ...
    public Mono<ServerResponse> handleException(HttpStatus status, Exception ex, ServerRequest request,
